export interface ShopAIConfig {
  ...
  communicationStyle?: {
    ...
    emojiUsage: 'none' | 'minimal' | 'friendly' | 'heavy';
    greetingMode: 'always' | 'once_per_session' | 'contextual' | 'never';
    formalityLevel: 'very_formal' | 'formal' | 'casual' | 'very_casual';
    sentenceStructure: 'short_punchy' | 'natural_flow' | 'detailed_paragraph';
    useShopkeeperVoice: boolean;
...
export interface Shop {
  ...
  sendpulseBotIds?: string[];
  sendpulseBots?: { id: string; channel: string }[];
