...
async def run_product_agent(user_msg, tool_info, ai_cfg, policies, profile, base_model_name, chat_history, past_purchases=None, delivery_info=None, payment_info=None, media_parts=None, shop_doc_id=None):
    ...
    extra_ctx = [
        ...
        "⚠️ RULE #1: Match products to [DATABASE INFO] by name, brand, or category.\n"
        "   Minor typos OK ('smart buld' → 'Smart Bulb', 'iphone' → 'iPhone').\n"
        "   If customer asks about a SPECIFIC product that exists → describe it naturally.\n"
        "   If customer asks about something NOT in database → say politely:\n"
        "   'ဒီပစ္စည်းကို ကျွန်မတို့ဆိုင်မှာ မတွေ့ပါဘူးရှင့်။ တခြားပစ္စည်းတွေ ကြည့်ချင်ပါသလား။'\n"
